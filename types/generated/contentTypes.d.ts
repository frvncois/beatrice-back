...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Content for the About section: hero image, intro paragraph, and details.';
    displayName: 'About';
    pluralName: 'abouts';
    singularName: 'about';
  };
...
export interface ApiMoodboardMoodboard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Content: Schema.Attribute.Component<'moodboard.content', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiScoreScore extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A sheet music score available for purchase in the Store section.';
    displayName: 'Score';
    pluralName: 'scores';
    singularName: 'score';
  };
  ...
  attributes: {
    buyUrl: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiWorkWork extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A musical composition. Displayed in the Work section of the site.';
    displayName: 'Work';
    pluralName: 'works';
    singularName: 'work';
  };
  ...
  attributes: {
    ...
    images: Schema.Attribute.Media<
      ...
      true
    >;
    instrumentation: Schema.Attribute.Text;
    key: Schema.Attribute.String;
    Lineup: Schema.Attribute.Component<'shared.lineup', true>;
    links: Schema.Attribute.Component<'shared.link-block', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::work.work'> &
      Schema.Attribute.Private;
    performanceNote: Schema.Attribute.Component<'shared.note-block', false>;
    programNote: Schema.Attribute.Component<'shared.note-block', false>;
    publishedAt: Schema.Attribute.DateTime;
    subtitle: Schema.Attribute.String;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
